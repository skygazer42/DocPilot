...
With documents from many domains and formats, accurate structural analysis is a challenging task. *Deep*Doc is built for that purpose.
...
We use vision information to resolve problems as human being.
  ...
  - Table Structure Recognition(TSR). Data table is a frequently used structure to present data including numbers or text.
    ...
    Along with TSR, we also reassemble the content into structured table output and readable text blocks.
